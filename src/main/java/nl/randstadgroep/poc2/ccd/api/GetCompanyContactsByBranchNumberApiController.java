...
@Controller
public class GetCompanyContactsByBranchNumberApiController implements GetCompanyContactsByBranchNumberApi {

    private static final Logger log = LoggerFactory.getLogger(GetCompanyContactsByBranchNumberApiController.class);
    ...
    public GetCompanyContactsByBranchNumberApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<ContactSituation>> getCompanyContactsByBranchNumber(@NotNull @ApiParam(value = "Branch unique number", required = true) @Valid @RequestParam(value = "BranchNumber", required = true) Long branchNumber
