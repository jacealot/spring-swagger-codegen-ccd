...
@Controller
public class GetContactsByBranchNumberApiController implements GetContactsByBranchNumberApi {

    private static final Logger log = LoggerFactory.getLogger(GetContactsByBranchNumberApiController.class);
    ...
    public GetContactsByBranchNumberApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<ContactSituation>> getContactsByBranchNumber(@NotNull @ApiParam(value = "Branch unique number", required = true) @Valid @RequestParam(value = "BranchNumber", required = true) Long branchNumber
