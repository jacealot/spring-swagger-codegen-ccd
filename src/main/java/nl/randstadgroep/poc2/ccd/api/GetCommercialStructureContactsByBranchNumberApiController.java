...
@Controller
public class GetCommercialStructureContactsByBranchNumberApiController implements GetCommercialStructureContactsByBranchNumberApi {

    private static final Logger log = LoggerFactory.getLogger(GetCommercialStructureContactsByBranchNumberApiController.class);
    ...
    public GetCommercialStructureContactsByBranchNumberApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<List<ContactSituation>> getCommercialStructureContactsByBranchNumber(@NotNull @ApiParam(value = "Branch unique number", required = true) @Valid @RequestParam(value = "BranchNumber", required = true) Long branchNumber
